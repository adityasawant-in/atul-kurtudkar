...
const LEADERSHIP = [
  { id: 'atul-kudtarkar', name: 'Atul Kudtarkar', role: 'Principal Structural Engineer', bio: 'Leads structural design and statutory approvals across every project the practice takes on.' },
]
